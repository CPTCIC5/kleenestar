...
from .channels import google, facebook, twitter, linkedin, reddit,tiktok, shopify, mailchimp, google_analytics, instagram
...
urlpatterns = [
    ...
    path("instagram/", instagram.instagram_oauth),
    path("instagram-callback/", instagram.instagram_oauth_callback),
    # path("instagram_data/", instagram.get_instagram_data)
