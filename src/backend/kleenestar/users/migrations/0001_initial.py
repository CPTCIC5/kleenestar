    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(blank=True, choices=[('Developer', 'Developer'), ('Manager', 'Manager'), ('Designer', 'Designer')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audience_type', models.CharField(choices=[(1, 'Beginner'), (2, 'Intermediate')], max_length=80)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workspace', to='users.profile')),
            ],
        ),
    ]
