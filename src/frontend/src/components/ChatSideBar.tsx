import { CircleX, Ellipsis, Folders, FolderUp, PenLine, SquarePen, Trash2 } from "lucide-react";
...
const ChatSideBar: React.FC<ChatSideBarProps> = ({ SideBar, handleHide }) => {
    ...
    return (
        <aside
            ref={SideBar}
            className="bg-inherit transform transition-all duration-300 mq750:rounded-r-3xl mq750:rounded-b-3xl  mq750:max-w-[324px]  max-w-[375.93px] w-full h-full flex flex-col "
        >
