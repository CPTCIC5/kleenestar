...
const Login: FunctionComponent = () => {
  return (
    <div className="flex flex-row items-start justify-center w-full">
      <div className="w-full max-w-[50%] relative flex flex-col items-start justify-start pt-[30px] py-[0px] px-[113px] tracking-[normal] text-left text-xl text-darkslateblue-100 font-montserrat lg:flex-wrap mq750:gap-[67px_33px] mq750:pl-14 mq750:pr-14 mq750:box-border mq450:gap-[67px_17px] mq450:pl-5 mq450:pr-5 mq450:box-border">
        <div className="flex flex-col items-start justify-start min-w-[495px] min-h-[734px] max-w-full lg:flex-1 lg:min-h-[auto] mq750:min-w-full">
      ...
      <div className="w-full max-w-[50%] flex items-end justify-middle">
        <FrameComponent />
      </div>
    </div>
  );
