...
const PasswordSaved: FunctionComponent = () => {
  return (
    <div className="w-full relative overflow-hidden flex flex-col items-center justify-start pt-[11px] px-5 pb-[0.4000000000001px] box-border gap-[58.69999999999982px] tracking-[normal] text-left text-6xl text-darkslateblue-100 font-syne mq450:gap-[29px_58.7px]">
