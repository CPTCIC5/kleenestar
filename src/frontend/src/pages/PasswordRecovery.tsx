...
const PasswordRecovery: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-whitesmoke overflow-hidden flex flex-col items-center justify-start pt-[71px] px-5 pb-[214.4000000000001px] box-border gap-[91.69999999999982px] tracking-[normal] text-left text-6xl text-darkslateblue-100 font-syne mq450:gap-[23px_91.7px] mq750:gap-[46px_91.7px]">
