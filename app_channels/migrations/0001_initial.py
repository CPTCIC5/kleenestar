    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#90EE90', '#90EE90'), ('#FFCCCC', '#FFCCCC'), ('#D3D3D3', '#D3D3D3'), ('#E6E6FA', '#E6E6FA'), ('#ADD8E6', '#ADD8E6')], max_length=30)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('knowledge_source', models.ManyToManyField(blank=True, null=True, to='app_channels.knowledgesource')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('similar_questions', models.TextField(blank=True, max_length=10000, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('convo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_channels.convo')),
            ],
            options={
                'ordering': ['author', 'id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('blocknote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_channels.blocknote')),
                ('prompt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_channels.prompt')),
            ],
        ),
        migrations.CreateModel(
            name='PromptFeedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('channel_type', models.IntegerField(choices=[(1, 'Google ads'), (2, 'Meta'), (3, 'X (Twitter)'), (4, 'Linkedin'), (5, 'TikTok'), (6, 'Reddit'), (7, 'Shopify'), (8, 'Google-Analytics'), (9, 'MailChimp'), (10, 'Instagram'), (11, 'Bing')])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('credentials', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_channels.apicredentials')),
                ('subspace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='workspaces.subspace')),
            ],
            options={
